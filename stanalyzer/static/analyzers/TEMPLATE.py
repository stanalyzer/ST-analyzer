...
try:
	...
	MY_DATA = 'DATA will be written'
	fid_my_output_file.write(MY_DATA);
	...
	gScript = gScript + """plot "{0}" using ($1*0.001):2 title "MY TITLE" with lines lw 3""".format(my_output_file);
