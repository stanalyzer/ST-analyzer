...
SECRET_KEY = '-wa6)*5uf%n^w1a+3c6@ztqbo9(@068^g8h%=!csj*@7j7p(ls'
...
ROOT_URLCONF = 'stanalyzer.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'stanalyzer.wsgi.application'
